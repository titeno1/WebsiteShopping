...
using WebCoreShop.Data;
using WebCoreShop.Models;
using WebCoreShop.Services;
using WebCoreShop.Data.EF;
using WebCoreShop.Data.Entities;
using AutoMapper;
using WebCoreShop.Application.Interfaces;
using WebCoreShop.Data.EF.Repositories;
using WebCoreShop.Data.IRepositories;
using WebCoreShop.Application.Implementation;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddDbContext<AppDbContext>(options =>
                ...
                o => o.MigrationsAssembly("WebCoreShop.Data.EF")));
