    ...
    function registerEvents() {
        ...
        $('#btnSave').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        obj.notify('Update role successful', 'success');
        ...
        $("#btnSavePermission").off('click').on('click', function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    obj.notify('Save permission successful', 'success');
                    $('#modal-grantpermission').modal('hide');
                    obj.stopLoading();
                },
                error: function () {
                    obj.notify('Has an error in save permission progress', 'error');
                    obj.stopLoading();
                }
            });
        });
