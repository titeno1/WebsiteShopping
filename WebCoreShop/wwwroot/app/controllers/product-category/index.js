        ...
        $("#fileInputImage").on('change', function () {
            ...
            $.ajax({
                ...
                success: function (path) {
                    $('#txtImage').val(path);
                    obj.notify('Upload image succesful!', 'success');

                },
                error: function () {
                    obj.notify('There was error uploading files!', 'error');
                }
            });
        });
        ...
        $('body').on('click', '#btnDelete', function (e) {
            ...
            obj.confirm('Are you sure to delete?', function () {
                $.ajax({
                    ...
                    success: function (response) {
                        obj.notify('Deleted success', 'success');
                        obj.stopLoading();
                        loadData();
                    },
                    error: function (status) {
                        obj.notify('Has an error in deleting progress', 'error');
                        obj.stopLoading();
                    }
                });
            });
        ...
        $('#btnSave').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        obj.notify('Update success', 'success');
                    ...
                    error: function () {
                        obj.notify('Has an error in update progress', 'error');
                        obj.stopLoading();
                    }
                });
            }
    ...
    function loadData() {
        $.ajax({
            ...
            success: function (response) {
                ...
                var treeArr = obj.unflattern(data);
